...
<body>
    <div id="wrap"> 
        ...
        <section class="write_review">
            <!-- action : 글 삭제 -->
            <form action="InsertReviewBoard.do" method="post">
                <table class="review_table">
                    ...
                    <tr>
                        <th>평점</th>
                        <td>
                            <input id="point0" type="radio" name="point" value="5" checked>
                            <label for="point0">
                                <span class="point5">
                                    <em>★★★★★</em>
                                </span>
                            </label>
                            <input id="point1" type="radio" name="point" value="4">
                            <label for="point1">
                                <span class="point4">
                                    <em>★★★★</em>
                                </span>
                            </label>
                            <input id="point2" type="radio" name="point" value="3">
                            <label for="point2">
                                <span class="point3">
                                    <em>★★★</em>
                                </span>
                            </label>
                            <input id="point3" type="radio" name="point" value="2">
                            <label for="point3">
                                <span class="point2">
                                    <em>★★</em>
                                </span>
                            </label>
                            <input id="point4" type="radio" name="point" value="1">
                            <label for="point4">
                                <span class="point1">
                                    <em>★</em>
                                </span>
                    ...
                    <tr>
                        <td colspan="2">
                            <textarea name="content" class="main_text"></textarea>
                        </td>
                    </tr>
                    <tr>
                        <th>UCC URL</th>
